...
/* harmony import */ var _modules_my_moduls_mobile_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/my-moduls/mobile-menu */ "./js/modules/my-moduls/mobile-menu.js");
/* harmony import */ var _modules_my_moduls_callbacl_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/my-moduls/callbacl-form */ "./js/modules/my-moduls/callbacl-form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_my_moduls_mobile_menu__WEBPACK_IMPORTED_MODULE_3__["openMobileMenu"])();
  Object(_modules_my_moduls_callbacl_form__WEBPACK_IMPORTED_MODULE_4__["validateForm"])();
...
/***/ "./js/modules/my-moduls/callbacl-form.js":
/*!***********************************************!*\
  !*** ./js/modules/my-moduls/callbacl-form.js ***!
  \***********************************************/
...
/* harmony import */ var _form_validate_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../form-validate/form */ "./js/modules/form-validate/form.js");

var formValidator = new _form_validate_form__WEBPACK_IMPORTED_MODULE_0__["Form"]();
var form = document.querySelector('[data-form]');
var modal = document.querySelector('[data-modal="success"]');
var error = document.querySelector('[data-modal="error"]');
var phoneInput = document.querySelector('[data-phone-input]');
var clickHendler = function clickHendler() {
  modal.classList.remove('is-active');
...
var submitHednler = function submitHednler(evt) {
...
/***/ "./js/modules/my-moduls/mobile-menu.js":
/*!*********************************************!*\
  !*** ./js/modules/my-moduls/mobile-menu.js ***!
  \*********************************************/
/*! exports provided: openMobileMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var mobileMenuList = document.querySelector('[data-mobile-menu-list]');
var mobileMenuLink = document.querySelector('[data-mobile-link]');
var mobileMenuLinks = document.querySelectorAll('[data-mobile-link]');
var closeButton = document.querySelector('[data-close-mobile-menu]');
var openButton = document.querySelector('[data-burger]');
var mainLogo = document.querySelector('[data-main-logo]');
var navLogo = document.querySelector('[data-nav-logo]');
var focusLock = new _utils_focus_lock__WEBPACK_IMPORTED_MODULE_0__["FocusLock"]();
var main = document.querySelector('main');
var sections = document.querySelectorAll('section');
var closeMenuHendler = function closeMenuHendler() {
...
var unscrollHandler = function unscrollHandler(e) {
  if (e.target === main) {
    closeMenuHendler();
  }
};
var openButtonHendler = function openButtonHendler() {
